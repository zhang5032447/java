package com.zw.mvcframework.v2.servlet;

import com.sun.net.httpserver.HttpContext;
import com.sun.net.httpserver.HttpHandler;
import com.zw.mvcframework.annotation.*;
...
public class GPDispatchServlet extends HttpServlet {
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        //==============IoC部分=================
        // 3. 初始化IoC容器，将扫描到的相关的类实例化，保持的IoC容器中
        doInstance();
        //AOP, 新生成的代理对象
    ...
    private void doAutowired() {
        ...
        for (Map.Entry<String, Object> entry : ioc.entrySet()) {
            ...
            //把所有的包括private/protected/default/public 修饰都取出来
